...
```bash
docker run --rm -v $(PWD):/home/data_analysis squisty/olympic_medal_htest:latest make -C /home/data_analysis
```
...
```bash
docker run --rm -v $(PWD):/home/data_analysis squisty/olympic_medal_htest:latest make -C /home/data_analysis clean
```
