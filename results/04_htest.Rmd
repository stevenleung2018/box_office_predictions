...
```{r summaryhtest, echo=FALSE, fig.cap="Figure 1. Hypothesis testing result", out.width = '80%'}
kable(summary, caption = "Table 1. Data summary.") |>
  kable_styling(full_width = FALSE, position = "left")
```

There are 131,134 athletes under age of 25 and 13.68% of them got a medal in the event, while there are 130,508 athletes equal to or above the age of 25 and 16.18% of them got a medal in the event.
...
kable(p_value, caption = "Table 2. p-value for the test.", col.names = 'p-value') |>
  kable_styling(full_width = FALSE, position = "left")
```
